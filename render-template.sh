...
FINDINGS=$(aws accessanalyzer validate-policy --policy-document file://$1 --policy-type RESOURCE_POLICY)
...
echo "Successfully rendered cloud formation template"
cat iam-stack-rendered.yaml